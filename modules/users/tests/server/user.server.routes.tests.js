 ...
 * Globals
 */
var app, agent, credentials, user, _user, admin, shop;
...
describe('User CRUD tests', function () {
      ...
      .end(function (signinErr, signinRes) {
        ...
        agent.get('/api/auth/signout')
          ...
          .end(function (signoutErr, signoutRes) {
            ...
            // NodeJS  more than v4 changed the status code representation so we must check
  ...
  it('should be able to login successfully and get shops', function (done) {
    agent.post('/api/auth/signin')
      .send(credentials)
      .expect(200)
      .end(function (signinErr, signinRes) {
        ...
        signinRes.body.email.should.be.equal(user.email);
        signinRes.body.shops.should.be.instanceof(Array).and.have.lengthOf(1);
        done();
      });
  });
